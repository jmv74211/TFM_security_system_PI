...
\noindent La aplicación consta de una serie de modos (manual, automático y streaming) con el que poder vigilar la zona que desees, y envía alertas automáticas a tu móvil en el caso de detectar alguna actividad sospechosa, capturar imágenes o grabar vídeos de forma manual, o visualizar la retransmisión en directo de la visualización de la cámara, y todo esto se puede controlar desde cualquier localización.
